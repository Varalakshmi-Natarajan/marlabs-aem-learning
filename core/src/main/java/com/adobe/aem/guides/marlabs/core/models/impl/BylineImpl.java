...
protected static final String RESOURCE_TYPE = "aem-learning/content/byline";
@ValueMapValue
private String name;
@ValueMapValue
...
{
	Resource byline = request.getResourceResolver().getResource(RESOURCE_TYPE);
	ValueMap map = byline.getValueMap();
	String componentGroup = map.get("componentGroup").toString();
